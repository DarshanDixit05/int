...
import Approve from "./approval.components";
import { Link } from "react-router-dom";

export default class Approval2 extends Component{
    render(){
        return(
            <div>
        ...
        <div class="row">
            ...
            <nav className="navbar navbar-dark bg-info  navbar-expand-lg" id="navbarResponsive"> 
